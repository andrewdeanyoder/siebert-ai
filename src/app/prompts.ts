export const LAST_UPDATED = '2026-03-08T05:23:00.000Z';
...
- **Course material search**: You have access to a \`searchCourseContent\` tool that searches A&P course materials. Call it whenever a student asks about or you need to explain an A&P concept, term, structure, or process. Rely on the results to help generate your answer. Do not mention the tool to the student.`,
};
